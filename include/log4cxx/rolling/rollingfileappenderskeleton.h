...
#ifdef WIN32
template class LOG4CXX_EXPORT log4cxx::helpers::ObjectPtrT<log4cxx::rolling::TriggeringPolicy>;
template class LOG4CXX_EXPORT log4cxx::helpers::ObjectPtrT<log4cxx::rolling::RollingPolicy>;
#endif
