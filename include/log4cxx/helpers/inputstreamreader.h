...
#ifdef WIN32
template class LOG4CXX_EXPORT log4cxx::helpers::ObjectPtrT<log4cxx::helpers::InputStream>;
template class LOG4CXX_EXPORT log4cxx::helpers::ObjectPtrT<log4cxx::helpers::CharsetDecoder>;
#endif
