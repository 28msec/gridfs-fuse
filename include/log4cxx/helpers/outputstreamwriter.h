...
#ifdef WIN32
template class LOG4CXX_EXPORT log4cxx::helpers::ObjectPtrT<log4cxx::helpers::OutputStream>;
template class LOG4CXX_EXPORT log4cxx::helpers::ObjectPtrT<log4cxx::helpers::CharsetEncoder>;
#endif
